...
Save the PRD into `d:\GIT-HUB\servenow\.zencoder\chats\3de6ec03-24ca-4ed3-ac90-755b1ead1133/requirements.md`.

### [ ] Step: Technical Specification

Based on the PRD in `d:\GIT-HUB\servenow\.zencoder\chats\3de6ec03-24ca-4ed3-ac90-755b1ead1133/requirements.md`, create a detailed technical specification to be used by a coding agent to implement the feature. Follow this template:
...
Save the spec to `d:\GIT-HUB\servenow\.zencoder\chats\3de6ec03-24ca-4ed3-ac90-755b1ead1133/spec.md`.

### [ ] Step: Implementation Plan

Based on the technical spec in `d:\GIT-HUB\servenow\.zencoder\chats\3de6ec03-24ca-4ed3-ac90-755b1ead1133/spec.md`, create a detailed task plan and update `d:\GIT-HUB\servenow\.zencoder\chats\3de6ec03-24ca-4ed3-ac90-755b1ead1133/plan.md`. Each task should have task definition, references to contracts to be used/implemented, deliverable definition and verification instructions.
