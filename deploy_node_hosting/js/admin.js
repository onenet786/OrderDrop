...
function printOrderReport() {
    ...
    const printContent = `
        ...
        <html>
        <head>
            <title>Order Reports - OrderDrop</title>
            <style>
                body {
        ...
        <body>
            ...
            <div class="footer">
                <p>This report was generated by OrderDrop Admin Panel</p>
            </div>
        </body>
        </html>
    `;
...
function buildAutoCustomerEmail(phoneRaw) {
    ...
    return `cust${phonePart}@orderdrop.flaura.pk`;
}
